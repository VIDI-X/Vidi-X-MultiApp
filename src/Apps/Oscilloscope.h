...
#include <complex.h>
#define FREQ2IND (SAMPLES2 * 1.0 / MAX_FREQ)
...
#define COEF3 3
#define SILENCE 1426
#define SENSITIVITY 300 // decrease for better sensitivity
...
private:
  ...
  unsigned long st, freq; // VIDI-X mod - dodano za freqvenciju
  int freqmax; // VIDI-X mod - dodano za freqvenciju
